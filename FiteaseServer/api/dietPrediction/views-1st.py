...
def results(request):
    ...
    print ("GOAL ISSSSSSSSSSSSSSSSSSS", type(fields["Goal"]) )
    recommendedFood = list()

    if fields["Goal"]=="Loss":

        print("Losssssssssssssssssssss")
        ...
        print('DietPrediction :',y_pred)
        #print('the  prediction length',len(y_pred))
    ...
    return JsonResponse({'DietPrediction':'success', 'prediction':recommendedFood}) 
